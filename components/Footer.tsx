  ...
  return (
    <footer className="py-8 px-6 border-t border-[#E5E5E5] bg-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm" style={{ color: '#A3A3A3', fontFamily: 'Inter, Helvetica Neue, Arial, sans-serif' }}>
          © {new Date().getFullYear()} Ron Deniele Paragoso. All rights reserved.
        </p>
        <div className="flex items-center gap-6">
          <a href="mailto:work.rparagoso@gmail.com" className="transition-colors hover:text-black text-[#A3A3A3]" aria-label="Email">
          ...
          <a href="https://linkedin.com/in/ron-paragoso" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-black text-[#A3A3A3]" aria-label="LinkedIn">
            LinkedIn
          </a>
          <a href="https://ronparagoso.vercel.app" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-black text-[#A3A3A3]" aria-label="Portfolio">
            Portfolio
          </a>
        </div>
      </div>
